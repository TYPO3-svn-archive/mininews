...
$TCA['tx_mininews_news'] = Array (
	...
	'columns' => Array (
		'hidden' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:lang/locallang_core.xml:labels.hidden',
			'config' => Array (
				'type' => 'check',
				'default' => '0'
			)
		...
		'starttime' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:lang/locallang_core.xml:labels.starttime',
			'config' => Array (
				'type' => 'input',
				'size' => '8',
				'max' => '20',
		...
		'endtime' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:lang/locallang_core.xml:labels.endtime',
			'config' => Array (
				'type' => 'input',
				'size' => '8',
				'max' => '20',
		...
		'fe_group' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:lang/locallang_core.xml:labels.fe_group',
			'config' => Array (
				'type' => 'select',
				'items' => Array (
					Array('', 0),
					Array('LLL:EXT:lang/locallang_core.xml:labels.hide_at_login', -1),
					Array('LLL:EXT:lang/locallang_core.xml:labels.any_login', -2),
					Array('LLL:EXT:lang/locallang_core.xml:labels.usergroups', '--div--')
				),
